        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center bg-bg-light p-8 md:p-16 overflow-auto shrink-0">
          <div className="w-full max-w-md flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* SSO Button */}
              <button
                className="w-full flex h-14 items-center justify-center overflow-hidden rounded-lg border border-slate-200 bg-white text-slate-700 text-base font-bold hover:bg-slate-50 transition-colors gap-3"
                type="button"
              >
